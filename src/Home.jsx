    ...
    return (
        <>
            ...
            <form onSubmit={handleFormSubmit}>
                <div className="flex justify-center items-center w-screen h-screen flex-col overflow-x-hidden bg-[url('/background.jpg')] bg-cover bg-center">
                {/* External Div */}
                <div className="mt-[5vw] min-w-[400px] min-h-[300px] border-2 border-dashed border-[#818183] bg-white p-4 rounded-2xl">
                    {/* Interior Div */}
